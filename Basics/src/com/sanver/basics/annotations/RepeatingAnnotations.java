package com.sanver.basics.annotations;
...
//To make it possible we must use the same modifiers in the @RepeatableAuthor annotation (i.e. @Documented, @Inherited, @Target and @Retention
@Documented
@Inherited
...
@RepeatableAuthor(name = "Abdullah Sanver", age = 35)
@RepeatableAuthor(name = "Hatice Sanver", age = 35)
class NewPerson {
