...
public class RecordSample {
     ...
     * Records are implicitly final, they cannot be extended. (Thus the sealed hierarchy is even more concise with records, no need for the modifiers final, sealed or non-sealed for a record extending a sealed class, since it will be regarded as final)
